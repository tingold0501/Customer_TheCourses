...
import INF from '../assets/images/company/netflix.svg';
import IAB from '../assets/images/company/airbnb.svg';
import IAMZ from '../assets/images/company/amazon.svg';
import IDB from '../assets/images/company/facebook.svg';
import IG from '../assets/images/company/grab.svg';
import I1 from '../assets/images/Rectangle 19.png';
import I2 from '../assets/images/Rectangle 21.png';
import ITC from '../assets/images/teacher-explaining.png';
import IVC from '../assets/images/vcall.png';
import IGWB from '../assets/images/girl-with-books.png';
import ITF from '../assets/images/true-false.png';
import IGB from '../assets/images/gradebook.png';
import IDC from '../assets/images/discussion.png';
import ITGT from '../assets/images/integrations.png';
import IT from '../assets/images/testimonials.png';
import ILTN from '../assets/images/laptop-news.png';
import ICLT from '../assets/images/children-laptop.png';
import IGLT from '../assets/images/girl-laptop.png';
import ICLT1 from '../assets/images/cat-laptop.png';
            ...
            <div className="container px-4 lg:px-8 mx-auto max-w-screen-xl text-gray-700 overflow-x-hidden">
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid grid-cols-3 lg:grid-cols-6 gap-4 justify-items-center">
                        <img className="h-7" src={IGG} />
                        <img className="h-7" src={INF} />
                        <img className="h-7" src={IAB} />
                        <img className="h-7 transform translate-y-2" src={IDB} />
                        <img className="h-7" src={IAMZ} />
                        <img className="h-7" src={IG} />
                    </div>
                </div>
                ...
                <div className="mt-28">
                    <div data-aos="flip-down" className="text-center max-w-screen-md mx-auto">
                        <h1 className="text-3xl font-bold mb-4">What is<span className="text-yellow-500">T-Academy?</span></h1>
                ...
                <div className="sm:flex items-center sm:space-x-8 mt-36">
                    ...
                    <div data-aos="fade-left" className="sm:w-1/2 relative mt-10 sm:mt-0">
                        ...
                        <img className="rounded-xl z-40 relative" src={ITC} alt />
                ...
                <div className="md:flex mt-40 md:space-x-10 items-start">
                    <div data-aos="fade-down" className="md:w-7/12 relative">
                        ...
                        <img className="relative z-50 floating" src={IVC} alt />
                ...
                <div className="flex flex-col md:flex-row items-center md:space-x-10 mt-16">
                    ...
                    <img data-aos="fade-left" className="md:w-1/2" src={IGWB} />
                </div>
                ...
                <div className="mt-20 flex flex-col-reverse md:flex-row items-center md:space-x-10">
                    <div data-aos="fade-right" className="md:w-6/12">
                        <img className="md:w-11/12" src={ITF} />
                    </div>
                ...
                <div className="flex flex-col md:flex-row items-center mt-12">
                    ...
                    <img data-aos="fade-left" className="md:w-7/12" src={IGB} />
                </div>
                ...
                <div className="mt-24 flex flex-col-reverse md:flex-row items-center md:space-x-10">
                    <div data-aos="fade-right" className="md:w-7/12">
                        <img className="md:w-11/12" src={IDC} />
                    </div>
                ...
                <div className="mt-24 flex flex-col md:flex-row items-start md:space-x-10">
                    <div data-aos="zoom-in-right" className="md:w-6/12">
                        <img className="md:w-8/12 mx-auto" src={ITGT} />
                    </div>
                ...
                <div className="mt-24 flex flex-col-reverse md:flex-row items-start md:space-x-10">
                    ...
                    <div data-aos="zoom-in-left" className="md:w-7/12">
                        <img className="md:w-10/12 mx-auto" src={IT} />
                    </div>
                </div>
                ...
                <div data-aos="zoom-in-up" className="my-14 flex flex-col lg:flex-row lg:space-x-20">
                    <div className="lg:w-6/12">
                        <img className="w-full mb-6" src={ILTN} />
                    ...
                    <div className="lg:w-7/12 flex flex-col justify-between mt-12 space-y-5 lg:space-y-0 lg:mt-0">
                        <div className="flex space-x-5">
                            <div className="w-4/12">
                                <div className="relative">
                                    <img className="rounded-xl w-full" src={ICLT} />
                        ...
                        <div className="flex space-x-5">
                            <div className="w-4/12">
                                <div className="relative">
                                    <img className="rounded-xl w-full" src={IGLT} />
                        ...
                        <div className="flex space-x-5">
                            <div className="w-4/12">
                                <div className="relative">
                                    <img className="rounded-xl w-full" src={ICLT1} />
                                    <span className="absolute bottom-2 right-2 bg-yellow-300 text-darken font-semibold px-4 py-px text-sm rounded-full hidden sm:block">NEWS</span>
                                </div>
                            </div>
                            <div className="w-8/12">
